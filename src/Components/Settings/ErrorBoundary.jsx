...
function Error() {
  return (
    <div className="flex h-full items-center justify-center p-5 w-full bg-white border rounded shadow-sm">
      <div className="text-center">
        ...
        <h1 className="mt-5 text-[36px] font-bold text-slate-800 lg:text-[50px]">Erreur</h1>
        <p className="text-slate-600 mt-5 lg:text-lg">
          Oups, quelque chose s'est mal passé. Essayez d'actualiser cette page ou n'hésitez pas à
